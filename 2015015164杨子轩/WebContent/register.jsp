...
<body>
	<!--注册开始-->
    <div class="reg">
        <form action="register.do" method="post" name="form1" id="form1" enctype="multipart/form-data">
            <dl>
                <dt class="f14 b">帐户基本信息</dt>
                
                <dd><span class="title">昵称：</span><input class="reg_input" name="user_name" id="iptNickName" onblur="checkNickName(this.value)" type="text" /><span id="iptNickNameTip" class="onshow"></span></dd>
                
              </dd>
            </dl>
            <dl>
                <dt class="f14 b">帐户安全设置</dt>
                <dd><span class="title">登录密码：</span><input class="reg_input" onblur="return checkpasswd(this);" id="t_UserPass" name="user_password" type="password"/><span id="t_UserPassTip" class="onshow"></span></dd>
                ...
                <dd><span class="title">真实姓名：</span><input name="RealName" id="iptName" class="reg_input" type="text" onblur="return isCnn(this)" /><span id="iptNameTip" class="onshow"></span></dd>
                <dd><span class="title">身份证号：</span><input class="reg_input" name='IDnumber' type='text' id='iptCard' onblur="return checktheform();" /><span id="iptCardTip" class="onshow"></span></dd>
                <dd><span class="title">邮箱地址：</span><input class="reg_input" name="user_email" type="text" id="t_Email" onblur="checkemail(this.value)" /><span id="t_EmailTip" class="onshow"></span></dd>
                <dd><span class="title">验证码：</span><input id="t_CheckCode" class="reg_input_pic" name="t_CheckCode" type="text" maxlength="4" />
                <img class="img" src="Images/eee.jpg" width="60" height="30" /></dd>
            </dl>
            ...
            <p><font color="red">${error}</font></font></p>
        </form>                              
    </div>
<!--注册结束--> 
</body>
